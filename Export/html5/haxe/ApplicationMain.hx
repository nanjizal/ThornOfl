...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SimpleSWFLayout", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SimpleSWFLayout", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SimpleSWFLayout";
		app.meta["name"] = "Simple SWF Layout";
		app.meta["packageName"] = "org.openfl.samples.simpleswflayout";
